...
public class SalesItemService {
	...
	public ItemResponses findAll(SalesStatus status, int size, Long cursor, Principal principal) {
		Slice<ItemResponse> itemResponses = salesPaginationRepository.findAll(status, size, cursor, principal);
