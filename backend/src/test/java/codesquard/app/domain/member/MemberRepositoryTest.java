...
class MemberRepositoryTest extends IntegrationTestSupport {
	...
	@Test
	public void findMemberByLoginIdIs() {
		// given
		Member member = Member.create("avatarUrl", "23Yong@gmail.com", "23Yong");
		memberRepository.save(member);
		String loginId = "23Yong";
		// when
		Member findMember = memberRepository.findMemberByLoginIdIs(loginId);
		// then
	...
	@Test
	public void findMemberByLoginIdIsWhenMemberIsNotExist() {
		// given
		String loginId = "23Yong";
		// when
		Member findMember = memberRepository.findMemberByLoginIdIs(loginId);
	...
	@Test
	public void existsMemberByLoginIdIs() {
		// given
		Member member = Member.create("avatarUrl", "23Yong@gmail.com", "23Yong");
		memberRepository.save(member);
		String loginId = "23Yong";
		// when
		boolean result = memberRepository.existsMemberByLoginIdIs(loginId);
		// then
