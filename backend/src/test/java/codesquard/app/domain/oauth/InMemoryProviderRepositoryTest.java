...
public class InMemoryProviderRepositoryTest extends IntegrationTestSupport {
	...
	public void findByProviderName() {
		...
		// when
		OauthProvider naverOauthProvider = providerRepository.findByProviderName(provider);
		// then
